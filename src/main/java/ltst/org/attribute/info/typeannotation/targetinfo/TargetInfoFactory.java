...
public class TargetInfoFactory {
    public static TargetInfo getInfo(byte targetType, ClassReader cr){
        switch (targetType){
            case 0x00:
            case 0x01:
                return new TypeParameterTarget(cr);
            case 0x10:
                return new SupertypeTarget(cr);
            case 0x11:
            case 0x12:
                return new TypeParameterBoundTarget(cr);
            case 0x13:
            case 0x14:
            case 0x15:
                return new EmptyTarget();
            case 0x16:
                return new FormalParameterTarget(cr);
            case 0x17:
                return new ThrowsTarget(cr);
            case 0x40:
            case 0x41:
                return new LocalvarTarget(cr);
            case 0x42:
                return new CatchTarget(cr);
            case 0x43:
            case 0x44:
            case 0x45:
            case 0x46:
                return new OffsetTarget(cr);
            case 0x47:
            case 0x48:
            case 0x49:
            case 0x4A:
            case 0x4B:
                return new TypeArgumentTarget(cr);
            default:
                return null;
        }
    }
